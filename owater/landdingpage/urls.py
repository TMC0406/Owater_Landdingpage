...
from . import views
from .views import about, contact, deliveryPolicy, detail, detailOrder, home, listOrder, order, orderInfo, orderSuccess, products, returnPolicy
...
urlpatterns = [
    ...
    path('detail-order/<str:idorder>', detailOrder, name='detailOrder'),
