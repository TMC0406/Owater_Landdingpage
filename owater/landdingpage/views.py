...
def about(request):
    metaData = {
        ...
        "page_keywords" : "Nước uống Kangen OWA High Oxygen được nghiên cứu và phát triển bởi công ty TNHH OWA Việt Nam, từ nguồn nước tự nhiên tươi mát kết hợp với công nghệ nâng cao Oxy trong nước..",
        "page_title" : "Về OWA",
        "page_image" : "https://www.owa.vn/static/assets/imgs/banners/Banner_Social.webp",
    }
...
def detail(request,type):
    if type == "A3" :
        metaData = {
            ...
            "page_keywords" : "Calcium: 80, Magnesium: 40, Potassium: 2, Sodium: 6.5, Nitrates: 3.8, Bicarbonates: 360, Sulfates: 3, Silica: 10, Chloride:s 0.7, PH: 8.0-8.5",
    ...
    if type == "A2" :
        metaData = {
            ...
            "page_keywords" : "Calcium: 80, Magnesium: 40, Potassium: 2, Sodium: 6.5, Nitrates: 3.8, Bicarbonates: 360, Sulfates: 3, Silica: 10, Chloride:s 0.7, PH: 8.5-8.9.",
    ...
    if type == "A1" :
        metaData = {
           "page_description" : "NƯỚC UỐNG KANGEN OWA TYPE A1 - PH 9.0-9.5. Giá bán: 100.000đ. Owarter bình 20L là loại nước cao cấp, khoáng chất hoàn toàn tự nhiên. Đặc biệt tốt cho cơ thể với độ pH cao, nồng độ ion hydroxide cao, vị ngọt thanh mát, trung hòa các gốc axit có hại, tốt cho người bị axit dạ dày, gout, và các bệnh liên quan đến axit dư thừa.",
            ...
            "page_keywords" : "Calcium: 80, Magnesium: 40, Potassium: 2, Sodium: 6.5, Nitrates: 3.8, Bicarbonates: 360, Sulfates: 3, Silica: 10, Chloride:s 0.7, PH:  9.0-9.5",
